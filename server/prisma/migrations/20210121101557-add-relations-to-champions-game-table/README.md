# Migration `20210121101557-add-relations-to-champions-game-table`

This migration has been generated by Donny Roufs at 1/21/2021, 11:15:57 AM.
...
ALTER TABLE "public"."Game" ADD FOREIGN KEY ("champion_id")REFERENCES "public"."Champion"("id") ON DELETE SET NULL ON UPDATE CASCADE

ALTER TABLE "public"."Game" ADD FOREIGN KEY ("opponent_id")REFERENCES "public"."Champion"("id") ON DELETE SET NULL ON UPDATE CASCADE
...
migration 20210119154452-add-champion-info-to-game-table..20210121101557-add-relations-to-champions-game-table
--- datamodel.dml
+++ datamodel.dml
@@ -3,9 +3,9 @@
 }
